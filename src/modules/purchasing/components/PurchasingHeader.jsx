                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="relative group cursor-pointer">
                                ...
                                <img src={companyLogo} alt="Logo" className="relative w-10 h-10 md:w-12 md:h-12 bg-slate-900 rounded-xl border border-slate-700/50 flex items-center justify-center shadow-2xl object-contain" />
                            </div>
                            <div>
